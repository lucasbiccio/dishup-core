package br.com.dishup.core.security;
 ...
 * @version 1.0 Class responsible for encapsulate the authentication and cryptographic logic
 */
public class CryptographSecurity {
	...
	/**
	 * Method responsible for encode an string into base64 type encoding.
	...
	/**
	 * Method responsible for decode an string from base64 type encoding to the original format.
	 * @param var - String encoded at base64 type encoding.
	...
	*/
	...
	/**
	 * Method responsible for cipher and var string using an specific algorithm into an array of bytes.
